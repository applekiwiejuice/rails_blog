...
class ArticleTest < ActiveSupport::TestCase
  ...
  test 'should not save when title is blank' do
    article = Article.new(title: "", description: "1234567890")
  ...
  test 'should not save when description is blank' do
    article = Article.new(title: "Lego: The Movie", description: "")
    assert_not article.save
  ...
  test 'should not save when description is less than 10 characters' do
    article = Article.new(title: "Lego: The Movie", description: "123456")
    assert_not article.save
  ...
  test 'should save when everything is awesome' do
    article = Article.new(title: "Lego: The Movie", description: "This is a Lego Movie.")
    assert article.save
  end
end
